  ...
  return (
    <div className="min-h-screen w-full bg-[#050505] text-white flex items-center justify-center p-4 sm:p-6 select-none relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-[#0F0E0D]/95 border border-[#FAB60A]/30 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2.5 p-3 rounded-lg bg-[#2E936F]/10 border border-[#2E936F]/30 text-[#2E936F] text-xs font-syne font-medium mb-6">
        ...
        {/* Error Notification */}
        {error && (
          <div className="flex items-start gap-2.5 p-3.5 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 text-xs font-sans mb-6">
