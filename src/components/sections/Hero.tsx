  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-between pt-28 pb-12 px-6 sm:px-12 overflow-hidden bg-brand-void">
      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-brand-void via-brand-void/80 to-brand-void/60" />
      </div>

      {/* Three.js Prism Interactive Layer */}
      <PrismScene />
      ...
      <div className="relative z-10 my-auto py-12 max-w-7xl mx-auto w-full">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-brand-orange/10 border border-brand-orange px-3 py-1 mb-6 text-[10px] font-syne tracking-micro text-brand-orange">
            <span className="h-1.5 w-1.5 bg-brand-orange animate-pulse" />
            <span>FASHPRISM INTERNATIONALS</span>
          </div>

          <h1 className="font-serif-display text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-light text-brand-off-white leading-[0.88] tracking-tight">
            FASHION
          ...
          <div className="mt-8 flex flex-col md:flex-row md:items-end justify-between gap-8 border-t border-hairline pt-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 flex-shrink-0">
              ...
              <Link
                href="/upcoming"
                className="border border-brand-gold/40 bg-brand-charcoal/60 px-8 py-4 text-xs font-syne tracking-caps text-brand-off-white hover:bg-brand-gold/10 transition-colors text-center"
                data-cursor="view"
              >
                LIFESTYLE 2026 ↗
              </Link>
      ...
      <div className="relative z-10 flex justify-between items-center text-[10px] font-syne tracking-micro text-brand-platinum pt-6 border-t border-hairline max-w-7xl mx-auto w-full">
        ...
        <span className="text-brand-orange">DUBAI — PARIS</span>
      </div>
    </section>
  );
}
