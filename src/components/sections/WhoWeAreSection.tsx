      ...
      <div className="container-editorial relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-12 gap-5 mt-8 items-stretch">
            ...
            <div className="order-1 lg:order-none lg:col-span-6 rounded-xl overflow-hidden border border-black/10 dark:border-white/10 relative w-full aspect-[16/9] sm:aspect-[16/9] lg:aspect-auto lg:h-full min-h-[200px] xs:min-h-[240px] sm:min-h-[300px] lg:min-h-[340px] bg-[#FAF8F5] dark:bg-[#0A0908] group shadow-sm flex items-center justify-center p-1 sm:p-0">
              <Image
            ...
            {/* Right Column Container on Laptop/Desktop (Holding Top 2 Cards + Upcoming Shows) */}
            <div className="contents lg:flex lg:flex-col lg:justify-between lg:gap-4 lg:col-span-6">
              {/* 2 Top Info Cards (INTERNATIONAL PLATFORM & GLOBAL COMMUNITY) */}
              ...
              {/* EXPLORE FASHAI ECOSYSTEM Card (UPCOMING SHOWS & CHAPTERS) */}
              <div className="order-4 lg:order-none relative p-6 sm:p-7 rounded-2xl bg-gradient-to-r from-[#F15E1C]/15 via-[#D4AF37]/10 to-[#FAF8F5] dark:from-[#F15E1C]/20 dark:via-[#D4AF37]/15 dark:to-[#0A0908] border border-[#F15E1C]/30 dark:border-[#D4AF37]/40 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-lg backdrop-blur-sm overflow-hidden group transition-all duration-300 hover:border-[#F15E1C]/50 dark:hover:border-[#D4AF37]/60 lg:flex-1">
