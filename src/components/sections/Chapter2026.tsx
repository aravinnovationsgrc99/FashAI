      ...
      <div className="relative z-10 container-editorial">
        ...
        >
          ...
          <p className="font-sans text-base sm:text-lg text-brand-platinum font-light leading-relaxed max-w-2xl mb-10">
            The next evolution of the Fesh AI Universe initiative. Bringing together computational fashion, spatial design, and exclusive delegate salons set against Dubai’s monumental landscape.
          </p>
