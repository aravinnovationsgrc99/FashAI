...
export default function Chapter2026() {
  return (
    <section id="2026" className="relative w-full flex flex-col justify-center py-14 sm:py-20 px-6 sm:px-12 bg-brand-void border-b border-hairline-orange overflow-hidden">
