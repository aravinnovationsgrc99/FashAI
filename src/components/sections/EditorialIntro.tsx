...
export default function EditorialIntro() {
  return (
    <section className="relative min-h-[85vh] w-full flex flex-col justify-center py-24 bg-brand-atelier border-t border-b border-hairline-gold overflow-hidden">
      <div className="container-editorial">
        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <motion.span
            ...
            className="h-[1.5px] w-32 bg-gradient-to-r from-[#F5DFB3] via-[#D4AF37] to-transparent origin-left"
          />
        </div>
        ...
        <div className="max-w-6xl">
          ...
          <motion.div
            ...
            className="mt-14 grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-t border-hairline-gold pt-10"
          >
            ...
            <div className="md:col-span-4 flex flex-col justify-end items-start md:items-end text-xs font-syne tracking-caps text-brand-gold space-y-2">
              <span>PARIS</span>
              <span>DUBAI</span>
              <span className="text-brand-gold font-bold border-b border-hairline-gold pb-1">EST. 2025</span>
            </div>
          </motion.div>
        </div>
      </div>
