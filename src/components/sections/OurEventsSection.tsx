...
export default function OurEventsSection() {
  return (
    <section className="relative py-24 sm:py-32 bg-brand-void border-b border-hairline-orange overflow-hidden">
      ...
      <div className="absolute top-1/4 left-10 w-96 h-96 bg-brand-orange/5 blur-3xl pointer-events-none rounded-full" />
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-brand-green/5 blur-3xl pointer-events-none rounded-full" />
