  ...
  return (
    <section id="people" className="relative py-24 sm:py-32 bg-brand-void border-b border-white/10 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        ...
        <div className="absolute -bottom-10 right-0 text-[14vw] font-serif-display font-light text-white/[0.015] uppercase tracking-tighter leading-none pointer-events-none select-none">
          COMMUNITY
        </div>
      </div>
            ...
            >
              ...
              <div className={`relative ${category.aspectRatioClass} w-full overflow-hidden mb-6 bg-black`}>
                <Image
                  ...
                  priority={category.id === "designers"}
                />
